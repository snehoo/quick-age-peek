...
const LifeClock = () => {
  ...
  return (
    <ArticleShell>
      ...
      <Quote>"The shortness of life is not a problem to be solved. It is a fact to be lived with — and lived well." — Oliver Burkeman, Four Thousand Weeks</Quote>
      <H2>The Life Clock in Stoic Philosophy and Modern Thought</H2>
      ...
      <Paragraph>Moreover, the Stoics used the shortness of life as a central philosophical prompt. Seneca's <em>Letters</em> return repeatedly to this theme: time is the only resource that cannot be recovered once spent. Therefore, the question is not how much time you have, but what you do with it. Consequently, the life clock functions not as a countdown but as a compass — a directional tool rather than a threat.</Paragraph>
      <H3>Oliver Burkeman and the four thousand weeks framework</H3>
      ...
      <H2>Life Clock Time Versus Life Expectancy Calculators</H2>
