...
const WeeksOld = () => (
  <UnitArticleShell meta={meta} title="How Many Weeks Old Am I?">
    ...
    <Paragraph>The figure 52.1775 accounts for the average year including leap years (365.25 ÷ 7). For a more precise count: total days lived ÷ 7.</Paragraph>
    ...
    />
    <Paragraph>
      A year is abstract. A week — you know what 52 of those look like. When you realise you're roughly 1,800 weeks old (in your mid-30s), you start to think differently. A wasted week isn't just a blip in a year — it's one of the roughly 4,000 weeks {ext("https://www.who.int/data/gho/indicator-metadata-registry/imr-details/65", "the average person gets in a lifetime")}.
    </Paragraph>
    <Paragraph>
      This is the logic behind Tim Urban's famous {ext("https://waitbutwhy.com/2014/05/life-weeks.html", "Wait But Why post on life in weeks")}, which visualised an entire human life as a grid of 4,160 boxes. According to {ext("https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3818148/", "research on human memory")}, the weekly rhythm is one of the most psychologically natural units of time.
    </Paragraph>
    ...
    <Paragraph>Based on {ext("https://www.who.int/data/gho/indicator-metadata-registry/imr-details/65", "WHO life expectancy data")}: ~3,800 weeks at 73 years, ~4,160 at 80 years, ~4,680 at 90 years.</Paragraph>
