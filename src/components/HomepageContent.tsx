...
Example: Born 15 March 1990 → Today 17 May 2026
  → 36 full years elapsed (birthday passed in March 2026)
  → 2 full months since birthday (March → May)
  → 2 remaining days (15 May → 17 May)
  → Result: 36 years, 2 months, 2 days
        ...
        <div className="hp-author-strip">
          ...
          <div className="hp-author-text">
            ...
            <p className="hp-author-bio">
              ...
              correctly, every edge case handled. <Link to="/about" className="hp-author-link" style={{ display: "inline", border: "none", padding: 0, fontSize: "inherit", color: "inherit" }}>Read the full story →</Link>
            </p>
